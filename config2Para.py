...
#######################################
xCoord = [1.0, 2.0, 1.0, 2.0]
yCoord = [1.0, 1.0, 2.0, 2.0]
staIDs = []
...
cbr = constanze.Constanze.CBR(0.01, configuration.throughputPerStation, configuration.fixedPacketSize)
#cbr = constanze.traffic.Poisson(offset = 0.11, throughput = configuration.throughputPerStation, packetSize = configuration.fixedPacketSize)
